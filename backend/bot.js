...
const BOT_TOKEN = 'MTQ2NjY1NTQ0NDQzNTk5Mjc4MA.GBx570.gohDAisICbJActTpktdeebvtLmgFfgAAluxnrk'; // Discord bot token'ını buraya yapıştır
...
const PORT = 3001;
app.listen(PORT, () => {
  console.log(`🤖 Discord Bot API çalışıyor → http://localhost:${PORT}`);
